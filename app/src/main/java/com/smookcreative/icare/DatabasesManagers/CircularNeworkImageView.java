...
public class CircularNeworkImageView extends NetworkImageView {
    ...
    public CircularNeworkImageView(Context context) {
        super(context);

        init();
    }

    public CircularNeworkImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CircularNeworkImageView(Context context, AttributeSet attrs, int defStyle) {
